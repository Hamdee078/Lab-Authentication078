...
const productSchema = new mongoose.Schema({//กำหนดSchema โครงสร้างของตารางชนิดข้อมูลเป็นแบบไหน
...
module.exports = Product //ถ้ามีการเรียกใช้จากด้านนอกอย่าลืมส่วนนี้